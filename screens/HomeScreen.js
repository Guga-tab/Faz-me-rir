...
export default function HomeScreen({ navigation }) {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: Global.colors.backgroundColor, paddingTop: StatusBar.currentHeight || 0 }}>
      <View style={{ flex: 1, padding: 20, alignItems: 'center' }}>
        ...
        <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 40 }}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('Settings')}>
            <Ionicons name="person-circle-outline" size={30} color={Global.colors.textColor} />
          </TouchableOpacity>
        </View>

        <View style={{ alignItems: 'center', marginBottom: 30 }}>
          <Text style={{ fontSize: 48, fontWeight: 'bold', color: dailyBalance >= 0 ? Global.colors.textColor : 'red' }}>
        ...
        <View style={{ alignItems: 'center', marginBottom: 50 }}>
          <Text style={{ fontSize: 48, fontWeight: 'bold', color: Global.colors.textColor }}>
